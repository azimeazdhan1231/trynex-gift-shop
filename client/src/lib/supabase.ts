  ...
  const sampleProducts = [
    {
      ...
      variants: JSON.stringify({ colors: ["white", "black", "blue"], sizes: ["small", "medium", "large"] })
    },
    {
      ...
      variants: JSON.stringify({ sizes: ["S", "M", "L", "XL"], colors: ["white", "black", "navy", "red"] })
    },
    {
      ...
      variants: JSON.stringify({ themes: ["colorful", "elegant", "kids"] })
    }
  ];
